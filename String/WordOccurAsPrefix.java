 ...
 * Output: 2 Explanation: "pro" is prefix of "problem" which is the 2nd and the
 * 6th word in the sentence, but we return 2 as it's the minimal index. Example
 * 3:
 * 
 * Input: sentence = "i am tired", searchWord = "you" Output: -1 Explanation:
 * "you" is not a prefix of any word in the sentence.
 * 
 */
public class WordOccurAsPrefix {

	public int isPrefixOfWord(String sent, String sd) {

		String[] arr = sent.split(" ");

		for (int i = 0; i < arr.length; i++) {
			if (arr[i].startsWith(sd))
				return i + 1;
		}
